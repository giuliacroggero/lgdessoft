...
questoes=[{'titulo': 'Qual o resultado da operação 57 + 32?',
         ...
         {'titulo': 'Quem foi o criador do Facebook?',
          ...
          'correta': 'D'},
         {'titulo': 'O que você chama de medo das galinhas?',
          'nivel': 'dificil',
          'opcoes': {'A': 'Domesticphobia', 'B': 'Alektorophobia', 'C': 'Chickophobia', 'D': 'Chickenophobia'},
          'correta': 'B'},
         {'titulo': 'Que família governa a dinastia de Mônaco?',
          'nivel': 'dificil',
          'opcoes': {'A': 'Windsor', 'B': 'Al Khalifa', 'C': 'Grimaldi', 'D': 'Romanov'},
          'correta': 'C'},
         {'titulo': 'Quantos países existem no mundo?',
          'nivel': 'dificil',
          'opcoes': {'A': '193', 'B': '209', 'C': '195', 'D': '168'},
          'correta': 'C'},
         {'titulo': 'Qual é o maior órgão do corpo humano?',
          'nivel': 'dificil',
          'opcoes': {'A': 'Estômago', 'B': 'Coração', 'C': 'Fígado', 'D': 'Pele'},
          'correta': 'D'},
         {'titulo': 'Quem ganhou as primeiras 500 milhas de Indianápolis?',
          'nivel': 'dificil',
          'opcoes': {'A': 'Ray Harroun', 'B': 'Bobby Unser', 'C': 'AJ Foyt', 'D': 'Bobby Isaac'},
          'correta': 'A'},
         {'titulo': ' Qual era a nacionalidade de Charlie Chaplin?',
         'nivel': 'dificil',
         'opcoes': {'A': 'Russo', 'B': 'Americano', 'C': 'Britâncio', 'D': 'Francês'},
         'correta': 'C'},
         {'titulo': 'Qual animal faz mais barulho?',
         'nivel': 'dificil',
         'opcoes': {'A': 'Elefante', 'B': 'Tigre', 'C': 'Baleia', 'D': 'Leão'},
         'correta': 'C'},
